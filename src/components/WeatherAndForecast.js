  ...
  return (
    <div className="WeatherAndForecast">
      ...
      <div className="WeatherAndForecast__container">
        <Forecast weatherInfo={WeatherFetch.daily[0]} date={date[0]} />
        ...
        <Forecast weatherInfo={weatherInfo.daily[3]} date={date[5]} />
        <Forecast weatherInfo={weatherInfo.daily[4]} date={date[6]} />
      </div>
    </div>
  );
}
