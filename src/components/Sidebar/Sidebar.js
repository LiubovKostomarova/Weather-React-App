    ...
    <aside className="sidebar">
      <div className="sidebar-container">
        ...
        <div className="buttonGroup">
          <CButton color="dark">Temperature</CButton>
        ...
        <div className="sidebar-container_row">
          <h2>Sicily</h2>
        ...
        <div className="buttonGroup">
          <CButton color="light" variant="outline">
            <FontAwesomeIcon icon={faArrowLeft} /> Catania
          </CButton>
          <CButton color="light" variant="outline">
            Taormina <FontAwesomeIcon icon={faArrowRight} />
          </CButton>
        </div>
      </div>
    </aside>
